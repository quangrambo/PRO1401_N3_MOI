...
public class SanPhamServiceImpl implements SanPhamService{
    ...
    public List<SanPhamViewModel> getAll() {
        ...
        for (SanPhamModel sp : listAll) {
            listTable.add(new SanPhamViewModel(sp.getId(),sp.getMa(),sp.getTen(),sp.getSoLuong()));
        }
        return listTable;
    }
    ...
    public String getAdd(SanPhamViewModel sp) {
        SanPhamModel sanPham=new SanPhamModel(sp.getId(),sp.getMa(),sp.getTen(),sp.getSoLuong());
