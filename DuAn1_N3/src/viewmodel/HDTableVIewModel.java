...
public class HDTableVIewModel {
    ...
    public HDTableVIewModel(int id, String ma, String tenNhanVien, String tenKhachHang, String maPGG, Date ngayTao, Date ngayThanhToan, int tienGiam, int tongTien, int tienKhachDua, int tienThua, int tienKhachPhaiTra, int HinhThucThanhToan, String maChuyenKhoan, String trangThai) {
        this.id = id;
        this.ma = ma;
