...
public class HDCTRepository {
    ...
    public List<HDCTModel> getAll() {
        ...
        try ( Connection con = DBConnect.getConnection();  PreparedStatement pr = con.prepareStatement(qery)) {
            ...
            while (rs.next()) {
                HDCTModel ms = new HDCTModel(rs.getInt(1), rs.getInt(2), rs.getInt(3), rs.getString(4),rs.getString(5),rs.getString(6),rs.getString(7),rs.getString(8), rs.getInt(9), rs.getFloat(10));
                listMS.add(ms);
            }
            return listMS;
        } catch (Exception e) {
    ...
    public List<GioHangModel> getAllTable() {
        ...
        try ( Connection con = DBConnect.getConnection();  PreparedStatement pr = con.prepareStatement(qery)) {
            ...
            while (rs.next()) {
                GioHangModel gh = new GioHangModel(rs.getInt(1), rs.getString(2), rs.getString(3), rs.getString(4),rs.getString(5),rs.getString(6),rs.getString(7),rs.getString(8), rs.getInt(9), rs.getFloat(10));
